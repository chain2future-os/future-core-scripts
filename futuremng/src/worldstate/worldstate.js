...
//配置文件目录与文件名
WorldState.configFilePath = utils.formatHomePath("~/.local/share/futureio/wssfuture/config/")
...
WorldState.start = async function (chainId, seedIp, totalTime, wsspath,local,chainConfig) {
    ...
    //await ShellCmd.execCmdFiles(Constants.cmdConstants.START_WORLDSTATE_FILE, Constants.cmdConstants.START_NODFUTURE_ARG, null);
