...
const mngConfigPath = "/root/.local/share/futureio/futuremng/config/config.ini";
...
var g_node_config_path = "/root/.local/share/futureio/nodfuture/config/config.ini";
var g_perl_script_path = `${toolsPath}/b58.pl`;
var g_seed_config_path = "/root/.local/share/futureio/futuremng/config/seedconfig.json";
...
async function votingRandomNum() {
    ...
    var account = nodeConfig["my-account-as-committee"].split(",")[0];
    var securityKey = nodeConfig["my-sk-as-account"].split(",")[0];
